...
export class InitialSchema1637786721637 implements MigrationInterface {
    name = 'InitialSchema1637786721637'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`UQ_users_ruc\` ON \`fast-education\`.\`users\``);
